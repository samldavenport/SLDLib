...
namespace sld {
    ...
    using os_window_opengl           = void*;
    using os_window_imgui            = ImGuiContext*;
    ...
    SLD_API_OS os_window_opengl os_window_init_opengl      (const os_window_handle window);
    SLD_API_OS os_window_imgui  os_window_init_imgui       (const os_window_handle window);
