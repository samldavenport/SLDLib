...
namespace sld {
    ...
    // directx12
    const os_window_error_s32  win32_window_directx12_update       (const os_window_handle_t window_handle, os_window_update_t&   update);
    const os_window_error_s32  win32_window_directx12_swap_buffers (const os_window_handle_t window_handle);
    ...
    SLD_API_OS_FUNC const os_window_error_s32
    win32_window_directx12_create(
        ...
        os_window_error_s32 error = {os_window_error_e_success};
        return(error);
    }
    ...
    SLD_API_OS_FUNC inline const os_window_error_s32
